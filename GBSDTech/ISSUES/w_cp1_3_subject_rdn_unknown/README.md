...
|--------|---------|------|---------|
| warn | CN=MYPBXManager SHAKEN, O=MYPBXManager LLC, ST=New York, C=US | [view](../../CERTIFICATES/a3872afd09406d2745d204893b6b52bbf6380f84/README.md) | Only CN, C, O, and SERIALNUMBER can be included. Additional RNDs may introduce ambiguity and may not be verifiable |
