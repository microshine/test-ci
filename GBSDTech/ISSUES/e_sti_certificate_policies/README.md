...
|--------|---------|------|---------|
| error | CN=MYPBXManager SHAKEN, O=MYPBXManager LLC, ST=New York, C=US | [view](../a3872afd09406d2745d204893b6b52bbf6380f84) | STI certificate shall include a Certificate Policies extension containing a single SHAKEN Certificate Policy |
