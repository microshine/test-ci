...
|--------|---------|------|---------|
| error | CN=cert.stir.t-mobile.com, OU=T-Mobile USA\\, Inc, O=T-Mobile USA\\, Inc., L=Bothell, ST=Washington, C=US | [view](../../CERTIFICATES/9ac0def10180cb22aad9e8885715c9409031697a/README.md) | STI certificates shall contain a BasicConstraints extension marked critical |
