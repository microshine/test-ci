...
|--------|---------|------|---------|
| warn | CN=cert.stir.t-mobile.com, OU=T-Mobile USA\\, Inc, O=T-Mobile USA\\, Inc., L=Bothell, ST=Washington, C=US | [view](../../CERTIFICATES/9ac0def10180cb22aad9e8885715c9409031697a/README.md) | Only CN, C, O, and SERIALNUMBER can be included. Additional RNDs may introduce ambiguity and may not be verifiable |
