...
|--------|---------|------|---------|
| error | CN=TalkAsiaVoip LLC SHAKEN 198K, O=TalkAsiaVoip LLC, ST=DE, C=US | [view](../../CERTIFICATES/360f1867f89798d6c73ce738d31f5db88dc645fd/README.md) | STI certificate shall contain '2.16.840.1.114569.1.1.3' policy |
